...
- **Credit Cards page**: static cheat-sheet at `/cards` (which card to use per purchase category, current Chase Freedom 5% quarter, expandable per-card details) — reachable from the settings drawer
