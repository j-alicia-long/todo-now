...
- **Pinned rates (added 2026-08-01)**: an Earn Rate can carry `pinned: true`, which makes it win its category regardless of nominal rate — the escape hatch for a non-rate perk judged to beat the rate winner. The only use: Amex Plat's $800/claim phone protection over Autograph's 3x on cell phone. The judgment lives in the data, not the engine.
